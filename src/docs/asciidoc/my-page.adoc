...
== 사용자가 작성한 레시피 목록 조회 API

=== Request

==== Header

include::{snippets}/get-my-recipes/request-headers.adoc[]

==== Query Parameter

include::{snippets}/get-my-recipes/query-parameters.adoc[]

==== Body

include::{snippets}/get-my-recipes/http-request.adoc[]

=== Response

==== 200 OK

include::{snippets}/get-my-recipes/http-response.adoc[]
