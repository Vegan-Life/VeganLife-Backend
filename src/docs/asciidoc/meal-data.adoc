...
include::{snippets}/meal-data-modify/request-headers.adoc[]

==== Path Variable

include::{snippets}/meal-data-modify/path-parameters.adoc[]

include::{snippets}/meal-data-modify/http-request.adoc[]

=== Response

==== 201 CREATED
include::{snippets}/meal-data-modify/http-response.adoc[]
...
include::{snippets}/meal-data-remove/request-headers.adoc[]

==== Path Variable

include::{snippets}/meal-data-remove/path-parameters.adoc[]

include::{snippets}/meal-data-remove/http-request.adoc[]

=== Response

==== 204 NO CONTENT
include::{snippets}/meal-data-remove/http-response.adoc[]
